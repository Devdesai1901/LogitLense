...
class Llama7BHelper:
    def __init__(self, use_local: bool = True, local_path: str = "./explanation/models_hf", token: str = None):
        print("Initializing Llama7BHelper...")
        ...
        for i, layer in enumerate(self.model.model.layers):
            # print(f"Wrapping layer {i} with BlockOutputWrapper...")
    ...
    def generate_with_probing(
        ...
        """
        Generate text while recording the prediction process for each token.
        ...
        Args:
            ...
            threshold: Threshold for identifying important layers
            print_details: Whether to print detailed prediction info
            
        Returns:
            List[PredictionStep]: List of prediction steps containing layer activations
                                 and token predictions for each generation step
        """
        prediction_steps = []
        current_text = prompt
        ...
        for step_idx in range(max_new_tokens):
            # Get layer activations for current step
